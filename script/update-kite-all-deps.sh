...
#
#
# run: kitep run --proxy update-kite-all-deps.sh
# run: kite run --proxy bash script/update-kite-all-deps.sh
# run: bash script/update-kite-deps.sh
# run: proxy_on; bash script/update-kite-all-deps.sh
